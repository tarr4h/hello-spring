...
<div id="demo-container" 
	...
	<form id="devFrm" method="POST">
		<input type="hidden" name="token" value="aaaaaaabbbbbbbbbbbbbcccccccccccc" />
		<div class="form-group row">
		  <label for="name" class="col-sm-2 col-form-label">이름</label>
		  <div class="col-sm-10">
		    <input type="text" class="form-control" id="name" name="name" value="한태우" required>
		  </div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
		    <input type="email" class="form-control" id="email" name="email" value="dinigo@naver.com" required>
		  </div>
		</div>
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="submit('dev3');" class="list-group-item list-group-item-action">Command 객체</button>
...
<script>
	const submit = (name) => {
		$(devFrm).attr("action", `${pageContext.request.contextPath}/demo/\${name}.do`).submit();
	}
