...
public class AdviceSignature {
	...
	public void afterReturningAdvice(JoinPoint joinPoint, Object returnObj) { // joinPoint에서 return한 객체
	...
	public void afterThrowingAdvice(JoinPoint jp, Exception exceptObj) { // 던져진 예외 객체
